...
Once a grid is established, the system of PDEs is converted into a \MarginPar{this paragraph and figure~\ref{fig:disc} need to be reworked}
...
the first data value will be associated at a point $\mydxh$ inside
