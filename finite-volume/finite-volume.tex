...
continuous function against a compact basis set represented by
...
The {\sf IPython} notebook \hydroexdoit{\href{https://github.com/zingale/hydro_examples/blob/master/finite-volume/conservative-interpolation.ipynb}{conservative-interpolation.ipynb}} shows how to derive these interpolants using {\sf SymPy}.
...
Note that conservation is not the same as accuracy.  We can construct the 
