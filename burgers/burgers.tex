...
\begin{quote}
\noindent {\em Here we will look at the inviscid Burgers' equation---this is the simplest
  nonlinear hyperbolic PDE, and will illustrate some of the rich phenomena that nonlinear
  PDEs enable.}
\end{quote}
...
the same limiters as with linear advection.  \MarginPar{add characteristic tracing}
