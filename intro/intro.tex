...
\begin{figure}
\centering
\includegraphics[width=0.49\linewidth]{midpoint}
\includegraphics[width=0.49\linewidth]{trapezoid} \\
\includegraphics[width=0.49\linewidth]{simpsons}
\begin{minipage}[b]{0.49\linewidth}
\caption[Integration rules]{\label{fig:integration} The midpoint rule (top left),
  trapezoid rule (top right) and Simpson's rule (left) for
  integration.}
\end{minipage}
\end{figure}
...
which the solution changes~\cite{byrnehindmarsh}.
