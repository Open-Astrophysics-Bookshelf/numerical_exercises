...
associated with them, and also involve more data points.
...
\begin{equation}
y^{n+1}_k = y^n_k + \Delta t f(t^{+1}, y^{n+1}_k)
\end{equation}
...
%
\caption{\label{fig:rk} A graphical illustration of the four steps in the $4^\mathrm{th}$-order
Runge-Kutta method.}
\end{figure}
