...
\begin{figure}
\centering
\includegraphics[width=3.125in]{rk4_initial.eps}\hspace{1em}
\includegraphics[width=3.125in]{rk4_k1.eps} \\
%
\includegraphics[width=3.125in]{rk4_k2}\hspace{1em}
\includegraphics[width=3.125in]{rk4_k3.eps} \\
%
\includegraphics[width=3.125in]{rk4_final.eps}\hspace{1em}\hspace{3.125em}
