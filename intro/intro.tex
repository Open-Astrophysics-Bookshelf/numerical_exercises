...
Written this way, we see that we can iterate, with the solution
for the $k$-th iteration looking like:
\begin{align}
...
networks (see, e.g., \cite{timmes_networks}).  As with the explicit
case, higher-order methods exist that can provide better accuracy at
reduced cost.
