...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\linewidth]{hydro1d_god_sod}
\caption{\label{fig:Euler:sod:god} Piecewise constant reconstruction
  ...
  problem setup, setting {\tt godunov\_type=1} and visualized with the
  {\tt sod\_compare.py} script there.}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=0.8\linewidth]{hydro1d_ppm_sod}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\linewidth]{hydro1d_god_double_rare}
\caption{\label{fig:Euler:doublerare:god} Piecewise constant
  ...
  \hydrooned\ using the {\tt sod} problem setup, setting {\tt
    godunov\_type=1} and visualized with the {\tt sod\_compare.py}
  script there.}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=0.8\linewidth]{hydro1d_ppm_double_rare}
...
%-----------------------------------------------------------------------------
\section{Method of lines integration and the higher order}
