...
\end{exercise}
An {\sf IPython} notebook using {\sf SymPy} that derives these is available here:
\hydroexdoit{\href{https://github.com/zingale/hydro_examples/blob/master/eigensystem/euler.ipynb}{euler.ipynb}}
\footnote{if you don't have {\sf IPython}, you can view this rendered online via {\sf nbviewer}:\\
\url{http://nbviewer.ipython.org/github/zingale/hydro_examples/blob/master/eigensystem/euler.ipynb}}
