...
\begin{align}
\wb_t^\evm + \lambda^\evm \wb_x^\evm &= 0 \\
\wb_t^\evz + \lambda^\evz \wb_x^\evz &= 0 \\
\wb_t^\evp + \lambda^\evp \wb_x^\evp &= 0 
\end{align}

If the system were linear, then the solution to each would simply be
to advect the quantity $\wb^\enu$ at the wave speed $\lambda^\enu$.  We
