...
\caption[Comparison of 2-d implicit diffusion with analytic
  ...
  diffusion of a Gaussian with the analytic solution at several times.
  The 2-d solution was averaged over angles to yield a profile as a 
  function of radius.
  This used Crank-Nicolson time-discretization and multigrid.  This
  can be run in \pyro\ as {\tt ./pyro diffusion gaussian
    inputs.diffusion} and visualized using the {\tt
    gauss\_diffusion\_compare.py} script there.}
\end{figure}
