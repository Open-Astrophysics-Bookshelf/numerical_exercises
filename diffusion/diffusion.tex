...
We specify boundary conditions by modifying the stencil (Eq.~\ref{eq:diff:implicit})
...
\begin{figure}[t]
\centering
\includegraphics[width=0.495\linewidth]{diff-implicit-128-CFL_0.8}
\includegraphics[width=0.495\linewidth]{diff-implicit-128-CFL_8.0}
\caption{\label{fig:diffuse} Implicit diffusion (with Crank-Nicolson discretization)
  with $\alpha = 0.8$ and $\alpha = 8.0$.}
\end{figure}
...
\end{equation}
This time-discretization is sometimes called.  Grouping all the 
