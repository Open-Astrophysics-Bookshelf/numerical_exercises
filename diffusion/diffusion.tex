...
solution.  \\ \hydroexdoit{\href{https://github.com/zingale/hydro_examples/blob/master/diffusion/diffusion-explicit.py}{diffusion-explicit.py}}}
\end{figure}
...
with $C > 1$, showing that the solution is unstable.
 \\ \hydroexdoit{\href{https://github.com/zingale/hydro_examples/blob/master/diffusion/diffusion-explicit.py}{diffusion-explicit.py}}}
\end{figure}
