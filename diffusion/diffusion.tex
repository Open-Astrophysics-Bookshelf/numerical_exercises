...
solution.  \\ \hydroexdoit{\href{https://github.com/zingale/hydro_examples/blob/master/diffusion/diffusion_explicit.py}{diffusion_explicit.py}}}
\end{figure}
...
with $C > 1$, showing that the solution is unstable.
 \\ \hydroexdoit{\href{https://github.com/zingale/hydro_examples/blob/master/diffusion/diffusion_explicit.py}{diffusion_explicit.py}}}
\end{figure}
...
\caption[Implicit diffusion of a Gaussian]{\label{fig:diffuse} Implicit diffusion of a Gaussian (with Crank-Nicolson discretization)
  ...
  line. \\
  \hydroexdoit{\href{https://github.com/zingale/hydro_examples/blob/master/diffusion/diffusion_implicit.py}{diffusion_implicit.py}}}
\end{figure}
