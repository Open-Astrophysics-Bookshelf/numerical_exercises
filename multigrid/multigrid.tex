...
\begin{figure}[t]
\centering
\includegraphics[width=0.6\linewidth]{poisson_fft}
\caption[FFT solution to the Poisson equation]{\label{fig:mg:fftpoisson}
  Solution to the Poisson equation with source from Eq.~\ref{eq:mg:fftsource}.  \hydroexdoit{\href{https://github.com/zingale/hydro_examples/blob/master/elliptic/poisson_fft.py}{poisson\_fft.py}}}
\end{figure}
