...
\caption{\label{fig:adv:domains} Space-time diagrams showing the
...
\caption[Method-of-lines spatial reconstruction]{\label{fig:advection:riemann-mol} Piecewise linear reconstruction
of the zones showing the interface states used with the method of lines
approach.}
\end{figure}

Note that there is no time-level indicated on the righthand side.  We
find the interface values of $a$ by interpolating in space only (see Figure~\ref{fig:advection:riemann-mol}, as:
\begin{align}
